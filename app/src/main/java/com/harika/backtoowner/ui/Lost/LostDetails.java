...
public class LostDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String docId = getIntent().getStringExtra("docId"); // Assuming you pass the itemName as an extra
        Log.d("DEBUG", "docId = " + docId);
        ...
        FirebaseFirestore.getInstance()
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(LostDetails.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
